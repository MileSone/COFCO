    ...
    function (ko, oj, data)
    {
        ...
        function DashboardViewModel() {
            ...
            self.compratio = ko.observableArray([
                {"faderatio": "1", "name": "销量", "value": "$150k", "rate": "100"},
                {"faderatio": "0.8", "name": "收入", "value": "$125k", "rate": "70"},
                {"faderatio": "0.8", "name": "毛利", "value": "$90k", "rate": "50"},
                {"faderatio": "0.6", "name": "费用", "value": "$60k", "rate": "40"},
                {"faderatio": "0.6", "name": "经营利润", "value": "$80k", "rate": "30"},
                {"faderatio": "0.6", "name": "市场份额CTR", "value": "$150k", "rate": "30"},
                {"faderatio": "0.6", "name": "市场份额_信息中心", "value": "$70k", "rate": "30"}
            ]);
